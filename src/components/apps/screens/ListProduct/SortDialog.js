...
const ProductSortDialog = ({ onSort, isVisible }) => {
  ...
  return (
    <Modal isVisible={isVisible} backdropOpacity={0.5} onRequestClose={() => setModalVisible(false)}>
      <View style={styles.container}>
        <Text style={{textAlign: 'center', marginHorizontal:10, fontWeight: '800', fontSize: 16, color: 'black'}}>Sort by</Text>
